...
**Note**: Many developers use multiple tools together. These aren't exclusive choices.
...
|------|------------|---------------|
| **Claude Code** | $20/mo (Pro), $100/mo (Max) | API pricing |
| **GitHub Copilot** | $10/mo (Pro), $39/mo (Pro+) | $19/user/mo |
| **Cursor** | $20/mo (Pro) | $40/user/mo |
...
| **Antigravity** | Google's agent-first AI IDE (Gemini) | Multi-agent orchestration, Google ecosystem |
...
- **Copilot**: Free tier + 1 month pro trial
- **Cursor**: Free tier + 1 week pro trial
- **Claude Code**: No free trial, but Max users can share a 1 week referral pass via `/passes`

---

**Bottom line**: Start with what fits your workflow, then add tools as needed.
